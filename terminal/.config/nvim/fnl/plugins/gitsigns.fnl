(fn config []
  ...
  (vim.keymap.set :n :<leader>ghp ":Gitsigns prev_hunk<CR>"
                  {:desc "[G]it [P]revious Hunk"})
  (vim.keymap.set :n :<leader>gha ":Gitsigns stage_hunk<CR>"
                  {:desc "[G]it [H]unk [A]dd"}))

{1 :lewis6991/gitsigns.nvim :version "*" : config}
